...
async function main() {
  console.log('🎯 FINAL: Minting with Actual Attestation PDA');
  console.log('==============================================');
  ...
  // The key insight: we need to use the ACTUAL attestation PDA that was created
  // instead of trying to derive it ourselves
  console.log('\n🔍 Key Insight: Using ACTUAL attestation PDA instead of deriving it');
  console.log('This bypasses the PDA derivation mismatch issue');

  try {
    console.log('\n🚀 Creating mintToKycUser instruction with ACTUAL attestation PDA...');
    ...
    const instruction = await program.methods
      ...
      .accounts({
        ...
        attestationAccount: attestationAccountPda, // Use the actual PDA
